import type { TComponent, TRelationship } from "@/types";
...
const RelationshipDisplay = ({
	...
	const firstComponentCenterPosition =
		getComponentCenterPosition(firstComponent);
	const secondComponentCenterPosition =
		getComponentCenterPosition(secondComponent);

	const height =
		secondComponentCenterPosition.y - firstComponentCenterPosition.y;
	const width =
		secondComponentCenterPosition.x - firstComponentCenterPosition.x;
	...
	return (
		<div
			...
			style={{
				top: Math.min(
					firstComponentCenterPosition.y,
					secondComponentCenterPosition.y,
				),
				left: Math.min(
					firstComponentCenterPosition.x,
					secondComponentCenterPosition.x,
				),
